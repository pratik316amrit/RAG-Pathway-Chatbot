...
def create_prompt_template():
    ...
    return ChatPromptTemplate.from_template(
        ...
        Make sure to give the detailed location of the answer using the metadata provided. For example, If the answer is from pdf named attention.pdf and the answer is from page 5, then in the answer mention the location as attention.pdf, page:5."
