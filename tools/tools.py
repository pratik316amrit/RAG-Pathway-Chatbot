...
api_key = {
    ...
    "WOLFRAM":os.environ["WOLFRAM_ALPHA_APPID"],
    "FINANCE":os.environ["FINANCE_API_KEY"]
}
...
def get_latest_earning_estimate(symbol: str) -> float:
    ...
    try:
        ...
        return f"Failed to get latest earning estimate: {e}"
...
def get_latest_news_for_stock(
 stock_id: str, limit: int = 10
    ...
    try:
        ...
        return f"Could not fetch articles: {e}"
